...
description: "Automate comprehensive WordPress SEO optimization including meta tags, schema markup, internal linking, and RankMath integration. Use when the user needs complete site SEO audits, bulk content optimization, or automated SEO workflows."
version: 1.0.0
homepage: https://github.com/ncreighton/empire-skills
metadata:
  {"openclaw":{"requires":{"env":["WORDPRESS_URL","WORDPRESS_USERNAME","WORDPRESS_APP_PASSWORD","RANKMATH_API_KEY"],"bins":["curl"]},"os":["macos","linux","win32"],"files":["SKILL.md"],"emoji":"🚀"}}
---
